...
const EventMultipledays = ({ setFormData, handleChange, formData, type }) => {
    ...
    <>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <DatePicker
          ...
          onChange={(date) => {
            setFormData((prev) => ({ ...prev, event_start_date: date }));
          }}
        ...
        <DatePicker
          className={`w-full uppercase px-5 py-3 rounded-lg  font-medium border-2 border-transparent placeholder-gray-500 text-sm focus:outline-none focus:border-2  focus:outline ${"bg-gray-100 text-black focus:border-black"}`}
          onChange={(date) => {
            setFormData((prev) => ({ ...prev, event_end_date: date }));
          }}
...
export default EventMultipledays;
